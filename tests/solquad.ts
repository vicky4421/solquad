...
describe("solquad", () => {
  ...
  const program = new Program<Solquad>(idl as Solquad, provider)
  const program2 = new Program<Solquad>(idl as Solquad, provider2)
